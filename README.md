...
## What's in here
  ...
  - visionary 
    ...
    - It is also worth noting that I have not figured out how to make ffmpeg deal with the proprietary colorspace of Dolby Vision Profile 5 (IPT-PQ-C), so I throw an error when I see it. It is not uncommon for streaming content to be Profile 5, but not _all_ Dolby Vision streaming content is Profile 5 and not even all versions of the same piece of content from different streamers is Profile 5 so if you have a Profile 5 stream, put in in the trash and go find a Profile 7 or 8 version, it's probably out there. Optionally, if you know how to make ffmpeg either work with the IPT-PQ-C colorspace properly OR convert it to a sane colorspace as part of the transcoding chain, open an issue and educate me, I would very much like to support this format.
